		...
		if (cmd.getName().equalsIgnoreCase("reply")) {
			...
			if((args.length > 0) && (args[0] != null)) {
				switch (args[0].toLowerCase()) {
					case "0": {playerColor = "BLACK"; break;}
					case "1": {playerColor = "DARK_BLUE"; break;}
					case "2": {playerColor = "DARK_GREEN"; break;}
					case "3": {playerColor = "DARK_AQUA"; break;}
					case "4": {playerColor = "DARK_RED"; break;}
					case "5": {playerColor = "DARK_PURPLE"; break;}
					case "6": {playerColor = "GOLD"; break;}
					case "7": {playerColor = "GRAY"; break;}
					case "8": {playerColor = "DARK_GRAY"; break;}
					case "9": {playerColor = "BLUE"; break;}
					case "a": {playerColor = "GREEN"; break;}
					case "b": {playerColor = "AQUA"; break;}
					case "c": {playerColor = "RED"; break;}
					case "d": {playerColor = "LIGHT_PURPLE"; break;}
					case "e": {playerColor = "YELLOW"; break;}
					case "clear": {playerColor = "clear"; break;}                                        
				...
				if (playerColor != null) {
					if (playerColor.equals("clear")) {
						...
						sender.sendMessage(Legendchat.getMessageManager().getMessage("messageColorSet"));
						return true;
					}
				}
			} else {
